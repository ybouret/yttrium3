...
namespace Yttrium
{
    namespace Apex
    {
        Natural Natural:: Div(const Natural &lhs, const Natural & rhs)
        {
            ...
            //return Natural(Directly, KegDiv::Compute<_Keg::WordType,_Keg::CoreType>(l.word,l.words, r.word,r.words) );
        }
        ...
        Natural Natural:: Mul(const Natural &lhs, natural_t rhs)
        {
            ...
            //return Natural(Directly, KegDivel::Compute<_Keg::WordType,_Keg::CoreType>(l.word,l.words,w,n) );
        }
        ...
        Natural Natural:: Mul(natural_t lhs, const Natural & rhs)
        {
            ...
            const KegType &              r = *static_cast<const KegType *>(rhs.code);
            //return Natural(Directly, KegMul::Compute<_Keg::WordType,_Keg::CoreType>(w,n,r.word,r.words) );
        }
