...
namespace Yttrium
{
    namespace Apex
    {
        Natural Natural:: Div(const Natural &lhs, const Natural & rhs)
        {
            ...
            return Natural(Directly, KegDiv::Quot<_Keg::WordType,_Keg::Core>(l.word,l.words, r.word,r.words) );
        }
        ...
        Natural Natural:: Div(const Natural &lhs, natural_t rhs)
        {
            ...
            return Natural(Directly, KegDiv::Quot<_Keg::WordType,_Keg::Core>(l.word,l.words,w,n) );
        }
        ...
        Natural Natural:: Div(natural_t lhs, const Natural & rhs)
        {
            ...
            const KegType &              r = *static_cast<const KegType *>(rhs.code);
            return Natural(Directly, KegDiv::Quot<_Keg::WordType,_Keg::Core>(w,n,r.word,r.words) );
        }
