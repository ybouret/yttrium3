...
namespace Yttrium
{
    ...
    namespace Cameo
    {
        namespace Sum
        {
            ...
            //
            //
            //! Sum of 3 items by type raising
            //
            //
            //__________________________________________________________________
            template <typename T>
            ...
            public:
                ...
                //
                //______________________________________________________________
                inline explicit Raised3() noexcept : Three<T>() { Y_Cameo_Sum_Raised_Check(); } //!< setup
                inline virtual ~Raised3() noexcept              {}                              //!< cleanup
            ...
            private:
                Y_Disable_Copy_And_Assign(Raised3); //!< cleanup
            };
        }
