...
#ifndef Y_Concurrent_VaList_Included
#define Y_Concurrent_VaList_Included 1
...
namespace Yttrium
{
    ...
    namespace Concurrent
    {
        ...
        private:
            ...
            VaList & record(const void * const) noexcept;
            VaList & mwrite(const void * const) noexcept;
            void     mquery(void * const)       noexcept;
...
#endif // !Y_Concurrent_VaList_Included
